						...
						<div class="toggle<?php if (!isset($_GET["settings-updated"])) { echo ' default-hidden'; } ?>">
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									...
									<tr>
										<th scope="row"><label class="description" for="gap_options[gap_enable]"><?php esc_html_e('Legacy Analytics', 'gap') ?></label></th>
										<td>
											...
											<?php esc_html_e('Enable', 'gap'); ?> <a target="_blank" href="http://code.google.com/apis/analytics/docs/tracking/asyncUsageGuide.html"><?php esc_html_e('Legacy Analytics', 'gap'); ?></a>
										</td>
									</tr>
									<tr>
