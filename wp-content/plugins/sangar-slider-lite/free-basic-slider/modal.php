	...
	<form id='sslider-modal-form'>
		...
		<div class="media-sidebar">
			...
			<div class="modal-sidetips" id="sidetips-content">
				...
				<p>
					<ul>
							...
							<li><strong>HTML</strong>: Using raw HTML as a content type, if you need more controll for your slides.</li>
					</ul>
				</p>
			</div>
			...
			<div class="modal-sidetips" id="sidetips-content-animation">
				...
				<p>
					Enable animation for better user experience. Animation duration is in milisecond, and animation stagger is animation delay time beetwen items.
				</p>
			</div>
		</div>
	</form>
