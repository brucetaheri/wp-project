	    ...
	    function modal_slide(slug)
	    {
	        ...
	        $.post(ajaxurl, data,function(response){
	            ...
	            if(response.success)
	            {
	                ...
	                // background mobile
	                $('[tab-bg-mobile-image] [media-upload-image]').attr('src',response.bg_type_img_mobile);
	                $('[tab-bg-mobile-image] [media-upload-image-url]').val(response.bg_type_img_mobile_url);
	                $('[tab-bg-mobile-image] [media-remove-button]').attr('data-image-default',response.bg_image_default);
