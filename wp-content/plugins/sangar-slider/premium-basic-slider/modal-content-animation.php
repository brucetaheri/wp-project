    ...
    <div class="widgets-holder-wrap exclude locked content-style-textbox">
        ...
        <div class="sidebar-content widgets-sortables clearfix">
            <table class="table-content"> 
                <tr>
                    <th scope="row" style="padding-top:7px;">
                        Time Between Transitions <br/>For Current Slide
                    </th>
                    <td>
                        <input class="regular-text" type="number" style="width:100px;" name="slide-advanceSpeed" value="" />
                        <label class="description" >Set to empty to use the global "Time Between Transitions" option</label>
                    </td>
                </tr>

                <tr>
                    <th colspan="2"><h3>Content Animation</h3></th>
                </tr>
                ...
                <tr valign="top" id='textbox_color'>
                    ...
                    <td>
                        <?php 
                            $arr_data = ssliderDefault::velocityTransition();                         
