...
{   
    ...
    $_POST['sslider_noncename'] = isset($_POST['sslider_noncename']) ? $_POST['sslider_noncename'] : '';
    if(! wp_verify_nonce( $_POST['sslider_noncename'], SANGAR_SLIDER)) return;
